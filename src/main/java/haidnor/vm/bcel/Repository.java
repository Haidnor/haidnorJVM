 ...
 */
package haidnor.vm.bcel;

import haidnor.vm.bcel.classfile.JavaClass;
import haidnor.vm.bcel.util.ClassPath;
import haidnor.vm.bcel.util.SyntheticRepository;
 ...
 *
 * @see haidnor.vm.bcel.util.Repository
 * @see SyntheticRepository
 */
public abstract class Repository {

    private static haidnor.vm.bcel.util.Repository repository = SyntheticRepository.getInstance();
     ...
     */
    public static haidnor.vm.bcel.util.Repository getRepository() {
        return repository;
    }
     ...
     */
    public static void setRepository(final haidnor.vm.bcel.util.Repository rep) {
        repository = rep;
    }
