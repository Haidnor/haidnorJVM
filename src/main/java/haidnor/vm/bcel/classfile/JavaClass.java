...
import haidnor.vm.bcel.generic.ClassGen;
import haidnor.vm.bcel.generic.Type;
import haidnor.vm.bcel.util.BCELComparator;
import haidnor.vm.bcel.util.ClassQueue;
import haidnor.vm.bcel.util.Repository;
...
public class JavaClass extends AccessFlags implements Cloneable, Node, Comparable<JavaClass> {
    ...
    public String toString() {
        ...
        buf.append(constantPool.toString()).append("\n");
