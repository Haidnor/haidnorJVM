 ...
 */
package haidnor.vm.bcel.classfile;

import haidnor.vm.bcel.generic.Type;
import haidnor.vm.bcel.util.BCELComparator;
 ...
 */
public final class MethodInfo extends FieldOrMethod {
    ...
    private static BCELComparator bcelComparator = new BCELComparator() {
        ...
        public boolean equals(final Object o1, final Object o2) {
            final MethodInfo THIS = (MethodInfo) o1;
            final MethodInfo THAT = (MethodInfo) o2;
            return Objects.equals(THIS.getName(), THAT.getName()) && Objects.equals(THIS.getSignature(), THAT.getSignature());
        }

        @Override
        public int hashCode(final Object o) {
            final MethodInfo THIS = (MethodInfo) o;
     ...
     */
    MethodInfo(final DataInput file, final ConstantPool constantPool) throws IOException, ClassFormatException {
     ...
     */
    public MethodInfo(final int accessFlags, final int nameIndex, final int signatureIndex, final Attribute[] attributes, final ConstantPool constantPool) {
     ...
     */
    public MethodInfo(final MethodInfo c) {
        super(c);
    }
     ...
     */
    public MethodInfo copy(final ConstantPool constantPool) {
        return (MethodInfo) copy_(constantPool);
    }
