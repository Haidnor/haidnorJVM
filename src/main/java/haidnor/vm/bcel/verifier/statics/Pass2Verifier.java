...
import haidnor.vm.bcel.generic.ArrayType;
import haidnor.vm.bcel.generic.ObjectType;
import haidnor.vm.bcel.generic.Type;
import haidnor.vm.bcel.verifier.PassVerifier;
import haidnor.vm.bcel.verifier.VerificationResult;
import haidnor.vm.bcel.verifier.Verifier;
import haidnor.vm.bcel.verifier.VerifierFactory;
import haidnor.vm.bcel.verifier.exc.AssertionViolatedException;
import haidnor.vm.bcel.verifier.exc.ClassConstraintException;
import haidnor.vm.bcel.verifier.exc.LocalVariableInfoInconsistentException;
...
public final class Pass2Verifier extends PassVerifier implements Constants {
    ...
    private final class CPESSC_Visitor extends EmptyVisitor {
        ...
        @Override
        public void visitDeprecated(final haidnor.vm.bcel.classfile.Deprecated obj) {// vmspec2 4.7.10
            checkIndex(obj, obj.getNameIndex(), CONST_Utf8);
        ...
        public void visitField(final Field obj) {
            ...
            final Attribute[] atts = obj.getAttributes();
            for (final Attribute att : atts) {
                if (!(att instanceof ConstantValue) && !(att instanceof Synthetic) && !(att instanceof haidnor.vm.bcel.classfile.Deprecated)) {
        ...
        public void visitJavaClass(final JavaClass obj) {
            ...
            for (final Attribute att : atts) {
                if (!(att instanceof SourceFile) && !(att instanceof haidnor.vm.bcel.classfile.Deprecated) && !(att instanceof InnerClasses) && !(att instanceof Synthetic)) {
