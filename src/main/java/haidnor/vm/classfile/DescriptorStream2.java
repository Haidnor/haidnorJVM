...
public class DescriptorStream2 extends ResourceObj {
    ...
    public void pushField(Object o, JavaVFrame frame) {
        switch (returnElement.getType()) {
            case Const.T_CHAR:
                frame.getStack().push(new StackValue(Const.T_CHAR, (char) o));

                break;
            case Const.T_INT:
                frame.getStack().push(new StackValue(Const.T_INT, (int) o));

                break;
            case Const.T_OBJECT:
                frame.getStack().push(new StackValue(Const.T_OBJECT, o));

                break;
            case Const.T_LONG:
                frame.getStack().push(new StackValue(Const.T_LONG, (int) o));

                break;
            case Const.T_DOUBLE:
                frame.getStack().push(new StackValue(Const.T_DOUBLE, (int) o));
