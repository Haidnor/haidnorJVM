...
public class CodeAttribute extends Attribute {
    ...
    /**
     * attribute_name_index 项的值必须是 constant_pool 表中的有效索引。
     * 该索引处的 constant_pool 条目必须是表示字符串“ Code ”的 CONSTANT_Utf8_info 结构（§4.4.7）。
     */
    ...
    public CodeAttribute(int attributeNameIndex, int attributeLength, int attributeNameIndex1, int attributeLength1, int maxStack, int maxLocals, int codeLength) {
